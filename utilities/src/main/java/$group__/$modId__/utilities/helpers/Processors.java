...
public enum Processors {
    ...
    public static ImmutableSet<TypeElement> getIntermediateSuperclasses(@Nullable TypeElement lower, @Nullable TypeElement upper, Types types) {
    ...
    public static ImmutableSet<TypeElement> getLowerAndIntermediateSuperclasses(@Nullable TypeElement lower, @Nullable TypeElement upper, Types types) {
        ...
        for (@Nullable TypeElement i = lower; i != upper && i != null; i = (TypeElement) types.asElement(i.getSuperclass())) r.add(i);
        return r.build();
    }
    ...
    public static <A extends Annotation> A[] getEffectiveAnnotationsIfInheritingConsidered(Class<A> annotationType, TypeElement type, ExecutableElement executable, Elements elements, Types types) {
    ...
    public static <A extends Annotation> A getEffectiveAnnotationIfInheritingConsidered(Class<A> annotationType, TypeElement type, ExecutableElement executable, Elements elements, Types types) throws IllegalArgumentException {
