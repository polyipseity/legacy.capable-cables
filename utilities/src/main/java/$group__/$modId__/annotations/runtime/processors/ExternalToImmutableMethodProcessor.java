...
import static $group__.$modId__.annotations.runtime.processors.IProcessorRuntime.makeMessage;
import static $group__.$modId__.utilities.concurrent.IImmutablizable.EXTERNAL_ANNOTATIONS_MAP;
import static $group__.$modId__.utilities.concurrent.IImmutablizable.EXTERNAL_METHOD_MAP;
