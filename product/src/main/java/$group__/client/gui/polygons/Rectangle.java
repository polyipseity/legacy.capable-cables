...
public class Rectangle<T extends Rectangle<T, N>, N extends Number> extends Polygon4<T, N, List<XY<?, N>>> {
	...
	public Rectangle(N offsetX, N offsetY, N sizeX, N sizeY, IMutatorImmutablizable<?, ?> mutator,
		...
		this(new XY<>(offsetX, offsetY, mutator, logging), new XY<>(sizeX, sizeY, mutator, logging), mutator, logging);
	}
	...
	@Override
	@Deprecated
	public void setA(XY<?, N> a) throws UnsupportedOperationException { throw Throwables.rejectUnsupportedOperation(); }

	@Override
	@Deprecated
	public void setB(XY<?, N> b) throws UnsupportedOperationException { throw Throwables.rejectUnsupportedOperation(); }

	@Override
	@Deprecated
	public void setC(XY<?, N> c) throws UnsupportedOperationException { throw Throwables.rejectUnsupportedOperation(); }
