...
@OnlyIn(CLIENT)
public abstract class GuiBackground<S extends ShapeDescriptor<? extends Rectangle2D>, D extends GuiComponent.Data<E>, E extends GuiComponent.Events> extends GuiComponent<S, D> {
	public GuiBackground(Function<? super Rectangle2D, ? extends S> shape, D data) { super(shape.apply(getShapePlaceholder()), data); }
