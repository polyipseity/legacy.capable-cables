...
@OnlyIn(Dist.CLIENT)
public class GuiBackgroundDirt<D extends GuiComponent.Data<E>, E extends GuiComponent.Events> extends GuiBackground<D, E> {
	public GuiBackgroundDirt(D data) { super(data); }
