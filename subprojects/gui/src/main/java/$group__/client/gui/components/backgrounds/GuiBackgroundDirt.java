...
@OnlyIn(Dist.CLIENT)
public class GuiBackgroundDirt<S extends ShapeDescriptor<? extends Rectangle2D>, D extends GuiComponent.Data<E>, E extends GuiComponent.Events> extends GuiBackground<S, D, E> {
	public GuiBackgroundDirt(Function<? super Rectangle2D, ? extends S> shape, D data) { super(shape, data); }
