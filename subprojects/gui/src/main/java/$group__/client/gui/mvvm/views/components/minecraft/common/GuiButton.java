package $group__.client.gui.mvvm.views.components.minecraft.common;

import $group__.client.gui.core.structures.AffineTransformStack;
import $group__.client.gui.core.structures.EnumCursor;
import $group__.client.gui.core.structures.EnumGuiMouseClickResult;
...
import $group__.client.gui.utilities.DrawingUtilities;
...
public abstract class GuiButton<S extends ShapeDescriptor<?>, D extends GuiButton.Data<?, ?>> extends GuiContainer<S, D> {
	...
	@Override
	public EnumGuiMouseClickResult onMouseClicked(final AffineTransformStack stack, GuiMouseButtonPressData drag, Point2D mouse, int button) {
	...
	@Override
	public boolean onMouseDragged(final AffineTransformStack stack, GuiMouseButtonPressData drag, Point2D mouse, int button) { return super.onMouseDragged(stack, drag, mouse, button) || stack.getDelegated().peek().createTransformedShape(getShapeDescriptor().getShape()).contains(mouse) && onButtonMouseReleased(button); }
