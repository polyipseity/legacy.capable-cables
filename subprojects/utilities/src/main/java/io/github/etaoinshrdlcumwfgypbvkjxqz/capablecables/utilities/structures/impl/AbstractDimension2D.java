...
public abstract class AbstractDimension2D
	...
	@NonNls
	private static final @Immutable Map<String, Function<Dimension2D, ?>> OBJECT_VARIABLES_MAP =
	...
	public boolean equals(@Nullable Object obj) {
		return ObjectUtilities.equalsImpl(this, obj, Dimension2D.class, true, getObjectVariablesMap().values());
	}

	@Override
	public String toString() {
		return ObjectUtilities.toStringImpl(this, getObjectVariablesMap());
	}

	public static @Immutable Map<String, Function<Dimension2D, ?>> getObjectVariablesMap() {
