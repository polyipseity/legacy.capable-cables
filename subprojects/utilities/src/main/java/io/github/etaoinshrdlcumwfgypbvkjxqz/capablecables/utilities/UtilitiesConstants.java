...
public enum UtilitiesConstants {
	...
	private static final Supplier<EnumBuildType> BUILD_TYPE = Suppliers.memoize(() -> EnumBuildType.valueOfSafe(getBuildTypeString())); // COMMENT lazy to prevent calling this before the module is configured
