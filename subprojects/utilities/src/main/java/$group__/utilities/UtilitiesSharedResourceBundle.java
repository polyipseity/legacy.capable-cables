...
import $group__.utilities.templates.SharedResourceBundleTemplate;
...
public final class UtilitiesSharedResourceBundle
	...
	public enum EnumKey
		...
		private static final @NonNls String RESOURCE_BUNDLE_PATH = "${group}.utilities.UtilitiesSharedResourceBundle";
