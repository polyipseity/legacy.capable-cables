...
public enum AffineTransformUtilities {
	...
	public static double[] getMatrix3x2IdentityView() { return MATRIX_3X2_IDENTITY.clone(); }

	public static AffineTransform getIdentityView() { return (AffineTransform) IDENTITY.clone(); }
