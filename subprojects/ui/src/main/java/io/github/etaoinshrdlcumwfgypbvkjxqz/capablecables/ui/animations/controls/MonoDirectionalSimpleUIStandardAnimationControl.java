...
public class MonoDirectionalSimpleUIStandardAnimationControl
		extends MonoDirectionalUIStandardAnimationControl {
	protected MonoDirectionalSimpleUIStandardAnimationControl(IUIAnimationTarget target,
	                                                          ITicker ticker,
	                                                          boolean autoPlay,
	                                                          long duration,
	                                                          long startDelay,
