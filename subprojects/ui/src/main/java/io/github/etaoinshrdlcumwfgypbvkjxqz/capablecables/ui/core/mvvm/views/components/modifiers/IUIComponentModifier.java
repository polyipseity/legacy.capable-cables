...
public interface IUIComponentModifier {
	...
	enum StaticHolder {
		...
		public static <M> Stream<Map.Entry<IUIComponentModifier, M>> streamSpecificModifiersUnion(Iterable<? extends IUIComponentModifier> modifiers,
		...
		public static <M> void handleComponentModifiers(M component,
		...
		@SuppressWarnings("UnstableApiUsage")
		public static <M> Stream<M> streamSpecificModifiers(Iterable<? extends IUIComponentModifier> modifiers,
		                                                    Class<M> modifierClass) {
			return Streams.stream(modifiers).sequential()
					.filter(modifierClass::isInstance)
		...
		public static <R, M, RInter> Optional<R> handleComponentModifiers(M component,
		                                                                  Iterable<? extends IUIComponentModifier> modifiers,
		                                                                  Class<M> modifierClass,
