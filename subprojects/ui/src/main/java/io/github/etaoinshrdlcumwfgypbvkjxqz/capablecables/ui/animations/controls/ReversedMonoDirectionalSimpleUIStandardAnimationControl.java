...
public class ReversedMonoDirectionalSimpleUIStandardAnimationControl
		extends ReversedMonoDirectionalUIStandardAnimationControl {
	protected ReversedMonoDirectionalSimpleUIStandardAnimationControl(IUIAnimationTarget target,
	                                                                  ITicker ticker,
	                                                                  boolean autoPlay,
	                                                                  long duration,
	                                                                  long startDelay,
