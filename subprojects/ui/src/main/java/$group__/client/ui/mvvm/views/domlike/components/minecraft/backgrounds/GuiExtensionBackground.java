package $group__.client.ui.mvvm.views.domlike.components.minecraft.backgrounds;
...
public abstract class GuiExtensionBackground implements IUIExtension {
	...
	public static final Registry.RegistryObject<IUIExtension.IType<GuiExtensionBackground, IUIComponentDOMLike>> TYPE = IUIExtension.Reg.INSTANCE.register(KEY, new IUIExtension.IType<GuiExtensionBackground, IUIComponentDOMLike>() {
		@Override
		public Optional<GuiExtensionBackground> get(IUIComponentDOMLike component) { return component.getExtension(KEY).map(CastUtilities::castUnchecked); }

		@Override
		public ResourceLocation getKey() { return KEY; }
	});
	protected WeakReference<IUIComponentDOMLike> container = new WeakReference<>(null);
	...
	protected Optional<IUIComponentDOMLike> getContainer() { return Optional.ofNullable(container.get()); }

	protected void setContainer(@Nullable IUIComponentDOMLike container) { this.container = new WeakReference<>(container); }
