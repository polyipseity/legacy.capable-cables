...
public interface IUIComponentManagerDOMLike
		extends IUIComponentDOMLike, IUIReshapeExplicitly {
	AffineTransformStack getCleanTransformStack();

	@SuppressWarnings("UnusedReturnValue")
	<CL extends IUIComponentDOMLike, R> Optional<R> callAsComponent(CL component, BiFunction<? super CL, ? super AffineTransformStack, ? extends R> action);
	...
	@Override
	default void onParentChange(@Nullable IUIComponentContainerDOMLike previous, @Nullable IUIComponentContainerDOMLike next)
			throws UnsupportedOperationException { throw new UnsupportedOperationException(); }
