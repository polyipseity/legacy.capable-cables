...
public abstract class ShapeDescriptor<S extends Shape, A extends IUIAnchorSet<?>> implements IShapeDescriptor<S, A> {
	...
	protected final WeakReference<IUIComponentDOMLike.IGuiView<?, ?>> view;
	protected boolean beingModified = false;

	public ShapeDescriptor(IUIComponentDOMLike.IGuiView<?, ?> view, S shape, A anchorSet) {
	...
	@Override
	public Optional<IUIComponentDOMLike.IGuiView<?, ?>> getView() { return Optional.ofNullable(view.get()); }
	...
	public static class Generic<A extends IUIAnchorSet<?>> extends ShapeDescriptor<Shape, A> {
		public Generic(IUIComponentDOMLike.IGuiView<?, ?> view, Shape shape, A anchorSet) { super(view, shape, anchorSet); }
	...
	public static class Rectangular<S extends RectangularShape, A extends IUIAnchorSet<?>> extends ShapeDescriptor<S, A> {
		public Rectangular(IUIComponentDOMLike.IGuiView<?, ?> view, S shape, A anchorSet) { super(view, shape, anchorSet); }
