...
import $group__.compat.convert.JavaConversionsExtension.asJavaLog4jSupplier
import $group__.macros.MacroTypeNames.getTypeFullName
...
object ModThis {
	...
	class CustomLanguageAdapter extends ILanguageAdapter.ScalaAdapter {
		...
		import $group__.compat.convert.JavaConvertersExtension._
