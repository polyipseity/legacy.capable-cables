...
public class GuiRectangleMatcher<T extends GuiRectangleMatcher<T, N, C, TH, D>, N extends Number, C extends Color, TH extends ITheme<TH>, D extends IDrawable<?>> extends GuiRectangle<T, N, C, TH> {
	/* SECTION variables */
	...
	public GuiRectangleMatcher(Rectangle<?, N> rectangle, D drawable, IMutatorImmutablizable<?, ?> mutator, ILogging<Logger> logging) {
	...
	protected GuiRectangleMatcher(GuiRectangleMatcher<?, N, ?, ?, ? extends D> copy, IMutatorImmutablizable<?, ?> mutator) { this(copy.getRectangle(), copy.getDrawable(), mutator, copy.getLogging()); }


	/* SECTION static methods */

	public static <T extends BuilderGuiDrawable<T, V, N, C, TH>, V extends GuiRectangleMatcher<V, N, C, TH, D>, N extends Number, C extends Color, TH extends ITheme<TH>, D extends IDrawable<?>> BuilderGuiDrawable<T, V, N, C, TH> newBuilderGRM(Rectangle<?, N> rectangle, D drawable) { return new BuilderGuiDrawable<>(t -> castUncheckedUnboxedNonnull(new GuiRectangleMatcher<>(rectangle, drawable, t.mutator, t.logging))); }
