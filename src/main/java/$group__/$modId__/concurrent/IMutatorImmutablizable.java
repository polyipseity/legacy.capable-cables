...
public interface IMutatorImmutablizable<T extends IMutator & IImmutablizable<I>, I extends IMutator & IImmutablizable<I>> extends IMutator, IImmutablizable<I> {
    ...
    static <T extends IMutator & IImmutablizable<I>, I extends IMutator & IImmutablizable<I>> IMutatorImmutablizable<T, I> of(T obj) {
        return obj instanceof IMutatorImmutablizable<?, ?>  ? castUncheckedUnboxedNonnull(obj) : new IMutatorImmutablizable<T, I>() {
            /* SECTION methods */
