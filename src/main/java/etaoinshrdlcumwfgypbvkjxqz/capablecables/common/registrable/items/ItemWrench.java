...
import etaoinshrdlcumwfgypbvkjxqz.capablecables.common.inventory.ContainerWrench;
...
import static etaoinshrdlcumwfgypbvkjxqz.capablecables.common.registrable.utilities.helpers.RegistrableHelper.Blocks.checkNoEntityCollision;
import static etaoinshrdlcumwfgypbvkjxqz.capablecables.common.registrable.utilities.helpers.RegistrableHelper.Blocks.getPosition;
import static etaoinshrdlcumwfgypbvkjxqz.capablecables.common.registrable.utilities.helpers.RegistrableHelper.NBT.*;
import static etaoinshrdlcumwfgypbvkjxqz.capablecables.utilities.helpers.Throwables.requireRunOnceOnly;
import static etaoinshrdlcumwfgypbvkjxqz.capablecables.utilities.variables.Constants.UNUSED;
import static etaoinshrdlcumwfgypbvkjxqz.capablecables.utilities.variables.References.*;
...
public class ItemWrench extends ItemUnstackable implements IEventBusSubscriber, IToolHammer, IToolWrench {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		if (playerIn.isSneaking()) {
			if (!worldIn.isRemote) playerIn.openGui(MOD, ContainerWrench.ID, worldIn, handIn.ordinal(), UNUSED.intValue(), UNUSED.intValue());
